...
the keys are the capital letters and the corresponding values the frequency of that letter
'''
...
def distance(frequency_dict, lang):
    '''returns the distance of frequency_dict to the dict letter_frequency[lang]
    
       frequency_dict: dict of the form {'A': 0.01, ..., 'Z': 0.002}
       lang: 'de' or 'en'
    '''
    d_lang = letter_frequency[lang]
